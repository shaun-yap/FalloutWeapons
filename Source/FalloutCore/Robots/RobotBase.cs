...
namespace RobotRamRod
{
	public class RobotCompHatcher : ThingComp
	{
		...
		public RobotCompProperties_Hatcher Props
		{
			get
			{
				return (RobotCompProperties_Hatcher)this.props;
			}
		}
		...
		public void Hatch()
		{
			try
			{
				PawnGenerationRequest request = new PawnGenerationRequest(this.Props.hatcherPawn, Faction.OfPlayer, PawnGenerationContext.NonPlayer, -1, false, true, false, false, true, false, 1f, false, true, true, false, false, false, false);
