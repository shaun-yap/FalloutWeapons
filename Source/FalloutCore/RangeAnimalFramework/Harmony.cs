	...
	public static class ARA__ManHunter_Patch
	{
		...
		static bool Prefix(ref JobGiver_Manhunter __instance, ref Job __result, ref Pawn pawn)
		{
            ...
            if (flag1 && flag2 && flag3 || flag4 && flag3)
            {
                ...
                __result = new Job(DefDatabase<JobDef>.GetNamed("FC_AnimalRangeAttack"), enemyTarget, JobGiver_AIFightEnemy.ExpiryInterval_ShooterSucceeded.RandomInRange, true)
                {
                    verbToUse = rangeVerb
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (flag15)
                            {
                                JobDef named = DefDatabase<JobDef>.GetNamed("FC_AnimalRangeAttack", true);
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (flag18)
                                    {
                                        JobDef named2 = DefDatabase<JobDef>.GetNamed("FC_AnimalRangeAttack", true);
